export const metadata = {
  ...
  alternates: { canonical: '/writing/the-59-try-rule' },
  openGraph: {
    type: 'article',
...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"The 59-Try Rule","description":"Why high-upside success is worth 59 shots — a mathematical case for low-cost, high-return experiments.","datePublished":"2025-08-04","url":"https://nickhuo.com/writing/the-59-try-rule","author":{"@type":"Person","name":"Jiajun (Nick) Huo","url":"https://nickhuo.com"}}`}</script>
