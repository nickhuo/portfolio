export const metadata = {
  ...
  alternates: { canonical: '/writing/proof-you-were-there' },
  openGraph: {
    type: 'article',
...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"The Shutter Is Proof You Were There","description":"On photography, presence, and the one thing a perfect AI image can't give back.","datePublished":"2026-05-24","url":"https://nickhuo.com/writing/proof-you-were-there","author":{"@type":"Person","name":"Jiajun (Nick) Huo","url":"https://nickhuo.com"}}`}</script>
