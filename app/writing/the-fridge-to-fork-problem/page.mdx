export const metadata = {
  ...
  alternates: { canonical: '/writing/the-fridge-to-fork-problem' },
  openGraph: {
    type: 'article',
...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"The Fridge-to-Fork Problem","description":"Why and how we built an ingredient-first recipe recommendation system","datePublished":"2025-08-22","url":"https://nickhuo.com/writing/the-fridge-to-fork-problem","author":{"@type":"Person","name":"Jiajun (Nick) Huo","url":"https://nickhuo.com"}}`}</script>
