export const metadata = {
  ...
  alternates: { canonical: '/writing/nowhere-to-go' },
  openGraph: {
    type: 'article',
...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"Nowhere to Go","description":"On the sanctuary effect, going offline, and what forced stillness gives back in an attention economy.","datePublished":"2026-03-18","url":"https://nickhuo.com/writing/nowhere-to-go","author":{"@type":"Person","name":"Jiajun (Nick) Huo","url":"https://nickhuo.com"}}`}</script>
