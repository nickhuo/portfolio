export const metadata = {
  ...
  description: 'How AI is reshaping the boundaries between design and engineering, and what that means for builders.',
  alternates: { canonical: '/writing/exploring-the-intersection-of-design-ai-and-design-engineering' },
  openGraph: {
    type: 'article',
...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"Exploring the Intersection of Design, AI, and Design Engineering","description":"How AI is reshaping the boundaries between design and engineering, and what that means for builders.","datePublished":"2025-08-04","url":"https://nickhuo.com/writing/exploring-the-intersection-of-design-ai-and-design-engineering","author":{"@type":"Person","name":"Jiajun (Nick) Huo","url":"https://nickhuo.com"}}`}</script>
